...
?>
<main class=" mt-5">
    <a href="add.php" class="btn btn-primary ms-4">Thêm</a>
    <table class="table">
        <thead>
            <tr>
        ...
        <tbody>
            ...
            ?>
                    ...
                    <th scope="row"><?php echo $row['id']; ?> </th>
                        ...
                        <td>
                            <a class="btn btn-info" href="edit.php?id=<?php  echo $row['id'] ?>">Sửa</a>
                            <a class="btn btn-danger" href="del.php?id=<?php  echo $row['id'] ?>">Xóa</i></a></a>
                        </td>
                    </tr>
            <?php
                }
